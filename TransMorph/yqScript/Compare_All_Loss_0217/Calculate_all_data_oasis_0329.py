...
class TestLossND(unittest.TestCase):
    ...
    def test_plot_comparison(self):
        ...
        oasis_file_paths = {
            'dust': r"D:\USERS\yq\code\TransMorph_Transformer\TransMorph_MultiScale\dust_oasis_noDsc_0327_loss.json",
            'trans': r"D:\USERS\yq\code\TransMorph_Transformer\OASIS\TransMorph\trans_oasis_noDsc_0327_loss.json",
            'vxm': r"D:\USERS\yq\code\TransMorph_Transformer\OASIS\TransMorph\vxm_oasis_noDsc_0327_loss.json"
        }
        ...
        for model in ["dust", "trans", "vxm"]:
            oasis_loss_data[model] = process_loss_dice_avg(oasis_file_paths[model])

        print(oasis_loss_data)
        # for model in ["dust", "trans", "vxm"]:
        #     semi_loss_data[model] = process_loss__dice_avg(semi_file_paths[model])
        #     no_semi_loss_data[model] = process_loss__dice_avg(no_semi_file_paths[model])
