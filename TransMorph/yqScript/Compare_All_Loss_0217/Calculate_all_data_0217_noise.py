...
def plot_comparison_single_model(model_name, semi_loss_data, no_semi_loss_data):
    ...
    for i in range(num_losses):
        ...
        plt.bar(['noise', 'simple'], [semi_value, no_semi_value], color=['skyblue', 'salmon'])
...
class TestLossND(unittest.TestCase):
    ...
    def test_plot_comparison(self):
        ...
        # 定义文件路径
        semi_file_paths  = {
            'dust': r"D:\USERS\yq\code\TransMorph_Transformer\TransMorph_MultiScale\dust_noise_loss_0202.json",
            'trans': r"D:\USERS\yq\code\TransMorph_Transformer\TransMorph\yqScript\Train250128_noise_rigid_noise\trans_0129_noisedata_loss.json",
            'vxm': r"D:\USERS\yq\code\TransMorph_Transformer\VoxelMorph_YQ\vxm_noise_0202_loss.json"
        }
        ...
        # }
        no_semi_file_paths = {
            'dust': r"D:\USERS\yq\code\TransMorph_Transformer\TransMorph_MultiScale\double_trans_simple_loss.json",
            'trans': r"D:\USERS\yq\code\TransMorph_Transformer\TransMorph\yqScript\Train1114\trans_simple_loss.json",
            'vxm': r"D:\USERS\yq\code\TransMorph_Transformer\VoxelMorph_YQ\vxm_loss.json"
        }
    ...
    def test_single_noise(self):
        ...
        # 定义文件路径
        semi_file_paths = {
            'trans': r"D:\USERS\yq\code\TransMorph_Transformer\TransMorph\yqScript\Train250128_noise_rigid_noise\trans_0217_noisedata_loss.json",
        }

        no_semi_file_paths = {
            'trans': r"D:\USERS\yq\code\TransMorph_Transformer\TransMorph\yqScript\Train_noSemi_0211\trans_0217_noSemi_noisedata_loss.json",
        }
