...
class TestLossND(unittest.TestCase):
    ...
    def test_plot_comparison(self):
        ...
        # }
        no_semi_file_paths = {
            'dust': r"D:\USERS\yq\code\TransMorph_Transformer\TransMorph_MultiScale\compare_dpi\double_dpi_dust_0402.json",
            'trans': r"D:\USERS\yq\code\TransMorph_Transformer\TransMorph_MultiScale\compare_dpi\transmorph_dpi_depart_loss_0402.json",
            'vxm': r"D:\USERS\yq\code\TransMorph_Transformer\TransMorph_MultiScale\compare_dpi\vxm_dpi_depart_loss_0402.json"
        }
