...
def main():
    ...
    exp_dir = r"Z:\users\yq\MorphDatasets\model\TransMorph\0217_sim\experiments"
    log_dir = r"Z:\users\yq\MorphDatasets\model\TransMorph\0217_sim\logs"
    ...
    for epoch in range(epoch_start, max_epoch):
        ...
        for data in train_loader:
            ...
            for n, loss_function in enumerate(criterions):
                if ct == 2:  # calculate the dice loss
                    curr_loss = loss_function(def_out.long(), x_seg.long(), labelNums) * weights[n]
                    print(f"dice loss : {curr_loss}")
