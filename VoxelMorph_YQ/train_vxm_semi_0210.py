...
def main():
    ...
    exp_dir = r"Z:\users\yq\MorphDatasets\model\TransMorph\voxelmorph\0210_semi\experiments"
    log_dir = r"Z:\users\yq\MorphDatasets\model\TransMorph\voxelmorph\0210_semi\logs"
