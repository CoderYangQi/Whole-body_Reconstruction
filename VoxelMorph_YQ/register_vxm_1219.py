...
def main():
    ...
    exp_dir = r"Z:\users\yq\MorphDatasets\model\TransMorph\voxelmorph\1206\experiments"
    log_dir = r"Z:\users\yq\MorphDatasets\model\TransMorph\voxelmorph\1206\logs"
    save_res = r"Z:\users\yq\MorphDatasets\model\TransMorph\voxelmorph\1206\result"
    ...
    save_tif = r"Z:\users\yq\MorphDatasets\Bspine\0305_visor_pic\vxm"
    ...
    # 保存为 JSON 文件
    with open("vxm_loss.json", "w") as file:
