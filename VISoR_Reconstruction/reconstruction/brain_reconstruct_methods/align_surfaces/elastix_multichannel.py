...
def align_surfaces(prev_surface, next_surface, ref_img: sitk.Image, prev_points=None, next_points=None,
    ...
    if prev_surface is not None:
        #prev_surface = sitk.Clamp(prev_surface, prev_surface.GetPixelIDValue(), outside_brightness)
        ...
        #next_surface = sitk.Clamp(next_surface, next_surface.GetPixelIDValue(), outside_brightness)
