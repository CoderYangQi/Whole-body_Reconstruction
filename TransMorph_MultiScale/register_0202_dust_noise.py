...
def TestNulti():
    ...
    exp_dir = r"Z:\users\yq\MorphDatasets\model\TransMorph\0202_dust\experiments"
    res_dir = r"Z:\users\yq\MorphDatasets\model\TransMorph\0202_dust\results"
    os.makedirs(res_dir, exist_ok=True)
    log_dir = r"Z:\users\yq\MorphDatasets\model\TransMorph\0202_dust\logs"
    ...
    with torch.no_grad():
        ...
        # 保存为 JSON 文件
    with open("dust_noise_loss_0202.json", "w") as file:
