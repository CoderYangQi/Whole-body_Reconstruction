...
import TransMorph.models.TransMorph as TM
import TransMorph.models.configs_TransMorph_bspl as configs
...
class TranMorphBSplineNet(nn.Module):
    def __init__(self,
        ...
        self.transform = transformation.CubicBSplineFFDTransform(ndim=3, svf=True, cps=cps,img_size=config.img_size)
