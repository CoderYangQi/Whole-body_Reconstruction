        ...
        if filename.split('.')[-1] == 'tar':
            with tempfile.TemporaryDirectory() as tmpdir:
                ...
                if _info['image_source'] is not None:
                    ...
                    self.image_origin = self.sphere[0]
...
if __name__ == '__main__':
    d = 'D:/Hao/reconstructed/cfos-FS5-2875_488/cfos-FS5-2875_488/8-cfos-FS5-2875-2018-01-26_14-26-09/8'
    c = VISoRColumnImage()
    c.src = [os.path.join(d, f) for f in os.listdir(d)]
    c.src.sort(key=lambda x: int(os.path.basename(x).split('.')[0]))
    sitk.WriteImage(c.get_image([(0, 0, 1000), (50, 100, 1200)]), 'D:/chaoyu/Test/t.tif')
